  ...
  render () {
    ...
    return (
      <div className='add-controls'>
        <i className='fa fa-file-text-o clickable' onClick={this.addTextBlock} title='New text block' />
        <i className='fa fa-file-code-o clickable' onClick={this.addCodeBlock} title='New code block' />
        <i className='fa fa-bar-chart clickable' onClick={this.addGraphBlock} title='New graph' />
      </div>
    )
  }
